...
#ifndef HOF_GUARD_RESULT_H
#define HOF_GUARD_RESULT_H
...
{
    HOF_INHERIT_CONSTRUCTOR(result_adaptor, detail::callable_base<F>)
    ...
    {
        return this->base_function(xs...)(HOF_FORWARD(Ts)(xs)...);
    };
};
...
struct result_adaptor<void, F> : detail::callable_base<F>
{
    ...
    {
        return (typename detail::holder<Ts...>::type)this->base_function(xs...)(HOF_FORWARD(Ts)(xs)...);
    };
};
