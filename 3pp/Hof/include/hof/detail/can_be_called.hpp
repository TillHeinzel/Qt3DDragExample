...
#ifndef HOF_GUARD_CAN_BE_CALLED_H
#define HOF_GUARD_CAN_BE_CALLED_H
...
: std::conditional<HOF_IS_CLASS(U) && !HOF_IS_FINAL(U), U, is_callable_wrapper_fallback<U>>
{};
...
template<class F, class... Ts>
HOF_USING(can_be_called, can_be_called_impl<F, detail::callable_args<Ts...>>);
