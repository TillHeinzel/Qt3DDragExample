...
#ifndef HOF_GUARD_UNPACK_TUPLE_HPP
#define HOF_GUARD_UNPACK_TUPLE_HPP
...
#define HOF_UNPACK_TUPLE_GET boost::hof::detail::tuple_get
#else
#define HOF_UNPACK_TUPLE_GET std::get

#endif

template<class F, class T, std::size_t ...N>
constexpr auto unpack_tuple(F&& f, T&& t, seq<N...>) HOF_RETURNS
(
    f(
        HOF_AUTO_FORWARD(HOF_UNPACK_TUPLE_GET<N>(HOF_AUTO_FORWARD(t)))...
    )
);
...
struct unpack_tuple_apply
{
    ...
    constexpr static auto apply(F&& f, S&& t) HOF_RETURNS
    (
        boost::hof::detail::unpack_tuple(HOF_FORWARD(F)(f), HOF_FORWARD(S)(t), boost::hof::detail::make_tuple_gens(t))
    );
};
