...
#ifndef HOF_GUARD_EVAL_H
#define HOF_GUARD_EVAL_H
...
{
    template<class F, class... Ts>
    constexpr HOF_SFINAE_RESULT(F) 
    operator()(F&& f, Ts&&...xs) const HOF_SFINAE_RETURNS
...
{
    template<class F, class... Ts>
    constexpr HOF_SFINAE_RESULT(F, id_<decltype(boost::hof::identity)>) 
    operator()(F&& f, Ts&&...xs) const HOF_SFINAE_RETURNS
...
HOF_DECLARE_STATIC_VAR(eval, boost::hof::first_of_adaptor<detail::simple_eval, detail::id_eval>);
