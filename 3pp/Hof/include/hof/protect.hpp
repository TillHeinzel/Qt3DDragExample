...
#ifndef HOF_GUARD_FUNCTION_PROTECT_H
#define HOF_GUARD_FUNCTION_PROTECT_H
...
/// [`lazy`](/include/hof/lazy) eargerly evaluates nested bind expressions.
/// The `protect` adaptor masks the type so `bind` or
/// [`lazy`](/include/hof/lazy) no longer recognizes the function as bind
...
struct protect_adaptor : detail::callable_base<F>
{
    ...
    HOF_INHERIT_CONSTRUCTOR(protect_adaptor, detail::callable_base<F>)
};

HOF_DECLARE_STATIC_VAR(protect, detail::make<protect_adaptor>);
